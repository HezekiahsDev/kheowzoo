  ...
  return (
    ...
    >
      ...
      <div className="z-10 text-center mt-8">
        <h2 className="text-2xl md:text-3xl font-bold text-color-primary animate__animated animate__fadeIn animate__delay-3s">
          Contract Address
        </h2>
        <p
          className="text-lg md:text-xl text-blue-500 underline cursor-pointer mt-2 animate__animated animate__fadeIn animate__delay-3s"
